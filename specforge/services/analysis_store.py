...
def persist_analysis(requirements, ai_enhance, ai_provider, result, request_id=None):
    record = create_analysis_record(requirements, ai_enhance, ai_provider, result, request_id=request_id)
...
def fetch_analysis_history(limit=20, offset=0):
    records = list_analysis_records(limit=limit, offset=offset)
    items = [
        {
